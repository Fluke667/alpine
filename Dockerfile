...
EASYRSA_REQ_PROVINCE=Bavaria \
EASYRSA_REQ_CITY=Nuremberg \
EASYRSA_REQ_ORG=Fluke667s-CA \
EASYRSA_REQ_EMAIL=Fluke667@gmail.com \
EASYRSA_REQ_OU=EASY-CA \
...
OVPN_CONFIG=$OVPN_DIR/openvpn.conf \
